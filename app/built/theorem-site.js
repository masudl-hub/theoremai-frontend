 ...
 *
 *   import { theoremSiteTheme } from './theorem-site';
 *   import './theorem-site.css';
 */
export const theoremSiteTheme = {
  name: 'theorem-site',
  __built: true,
  tokens: {
  ...
  components: {
    ...
    "lightbox": {
      "base": {
        ...
        "::backdrop": {
          "backgroundColor": "light-dark(#00000059, #00000099)"
        }
      }
    },
    "collapsible-content": {
      "base": {
        ...
        "transition": "height var(--duration-medium) var(--ease-standard), padding-top var(--duration-medium) var(--ease-standard), content-visibility var(--duration-medium) allow-discrete",
