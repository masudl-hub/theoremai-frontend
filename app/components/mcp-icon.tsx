...
/**
 * Model Context Protocol mark (from Simple Icons, CC0), filled in the current colour.
 * Tabler has no MCP icon; this marks MCP tools beside Tabler's glyphs for the other types.
 */
export function IconMcp(props: SVGProps<SVGSVGElement>) {
	return (
