...
export const SITE_DOC_SECTIONS: DocSectionContent[] = [
	...
	},
	{
		...
		lines: [
			...
			'- theorum/kernel: runTurn runner, registerTool registry, invokeTool, prepareTurnToolSnapshot.',
	...
	},
	{
		...
		lines: [
			...
			'- @theorum/core: defineProfile, registerProfile, runTurn, registerTool, invokeTool, createProvider, prepareTurnToolSnapshot.',
