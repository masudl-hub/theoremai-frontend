...
export const packageTree: PackageNode = {
	...
	children: [
		...
		folder('observability', 'observability/', 'src/observability/', [
			...
			file('observability_trace_span', 'trace-span.ts', 'src/observability/trace-span.ts'),
			file('observability_trace_sink', 'trace-sink.ts', 'src/observability/trace-sink.ts'),
			file('observability_destinations', 'destinations.ts', 'src/observability/destinations.ts'),
			file('observability_policy', 'policy.ts', 'src/observability/policy.ts'),
			file(
				'observability_resolve_policy',
				'resolve-policy.ts',
				'src/observability/resolve-policy.ts',
			),
			file('observability_types', 'types.ts', 'src/observability/types.ts'),
			file('observability_spans', 'spans.ts', 'src/observability/spans.ts'),
			file('observability_otlp', 'otlp.ts', 'src/observability/otlp.ts'),
			file('observability_openinference', 'openinference.ts', 'src/observability/openinference.ts'),
		]),
