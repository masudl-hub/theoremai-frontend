/**
 * Frontend adapter — demo seeds live in `theorum/playground`; this module only
 * adds canvas facet fields (`kind`, `expanded`) required by the graph editor.
 */
import type { PlaygroundInputsSpec, PlaygroundToolSeed } from 'theorum/playground';
import {
	DEMO_ALLOWED_HOSTS,
	DEMO_CONCIERGE_SYSTEM,
	demoInputsSpec,
	demoToolSpecs,
} from 'theorum/playground';
